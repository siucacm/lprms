...
public class Panel_UserItemList extends Panel {
    ...
    private void initComponents() {
        ...
        barcode.setText(resourceMap.getString("barcode.text")); // NOI18N
        ...
        informative.setText(resourceMap.getString("informative.text")); // NOI18N
    ...
    private class RefreshItemTask extends Task {
        ...
        @Override protected Void doInBackground() {
            ...
            for (int i = 0; i < items.size(); i++)
                data.addRow(items.get(i).getInfo());
            return null;
        }
        @Override protected void finished() {
            setMessage("Done");
